...
import { deleteServiceFromCart } from '../Redux/Action/CartAction';
        ...
        <>
            <header className="header">
                <div className="logo-wrap">
                    ...
                    {cartItems ? (<>  <h6 className="title-color font-md font-weight-bold">My Cart <span className="font-sm content-color">({cartItems?.length} Items)</span></h6></>) : (<>  <h6 className="title-color font-md font-weight-bold">My Cart <span className="font-sm content-color">({cartItemService?.length} Items)</span></h6></>)
            ...
            {/* cartItem */}
            {
                cartItemService?.length > 0 ? (<>
                                            ...
                                            <div className="swipe-to-show">
                                                <div className="product-list media cart-item">
                                                    <div className="cart-media">
                                                        <a>
                                                            <img src={`${BassURl}${data.service_image}`} alt="product" />
                                                        </a>
                                                        <button
                                                            className="cart-delete"
                                                            onClick={() => {
                                                                dispatch(deleteServiceFromCart(data));
                                                            }}
                                                        >
                                    ...
                                    cartItems && cartItems?.map((data) => {
                                        ...
                                        return (
                                            <>
                                                ...
                                                <footer className="footer-wrap footer-button">
                                                    <Link to="/address" className="font-md">Proceed to Checkout</Link>
                                                </footer>
                                            </>)
                                    })
                                }
                    ...
                    (<>
                        <main className="main-wrap empty-cart">
                            {/* Banner Start */}
                            <div className="banner-box">
                                <img src="/assets/icons/svg/empty-cart.svg" className="img-fluid" alt={404} />
                            </div>
                            {/* Banner End */}
                            {/* Error Section Start */}
                            <section className="error mb-large">
                                ...
                                <p className="content-color font-md">
                                    Looks like you haven’t added anything to your cart yet. You will find a
